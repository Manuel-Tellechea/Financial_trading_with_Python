...
exportList = pd.DataFrame(
    columns=['Stock', "Latest_Price", "RS_Rating", "50 Day MA", "150 Day Ma", "200 Day MA", "52 Week Low",
             "52 week High", "PE_Ratio", "PEG_Ratio"])
returns_multiples = []
...
for stock in rs_stocks:
    try:
        ...
        if (
            ...
            exportList = exportList.append({'Stock': stock, "Latest_Price": currentClose, "RS_Rating": RS_Rating,
                                            "50 Day MA": moving_average_50, "150 Day Ma": moving_average_150,
                                            "200 Day MA": moving_average_200, "52 Week Low": low_of_52week,
                                            "52 week High": high_of_52week, "PE_Ratio": pe_ratio,
                                            "PEG_Ratio": peg_ratio},
                                           ignore_index=True)
